...
- ONLY use these validation types: min_count, max_count, required_fields, url_same_host,
  title_min_length, content_min_length, field_min_length, not_equals, field_not_in,
  url_matches, field_matches, date_parseable, no_cookie_wall, description_not_boilerplate.
